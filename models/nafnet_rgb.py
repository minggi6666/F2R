"""NAFNet-style RGB denoiser used as the frozen coarse denoising branch."""
...
class Baseline(nn.Module):
    ...
    def __init__(self, img_channel=3, width=64, middle_blk_num=6, enc_blk_nums=[2, 2, 4], dec_blk_nums=[2, 2, 2],
